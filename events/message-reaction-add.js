	...
	for (var col = 0; col < response.game.length; col++) {
		for (var row = 0; row < response.game[col].length; row++) {
			if (response.game[col][row] !== 0) {
				...
				if (response.game[col + 1] && response.game[col + 1][row + 1] && response.game[col + 1][row + 1] !== 0 && response.game[col + 1][row + 1] === response.game[col][row]) {
					if (response.game[col + 2] && response.game[col + 2][row + 2] && response.game[col + 2][row + 2] !== 0 && response.game[col + 2][row + 2] === response.game[col + 1][row + 1]) {
						if (response.game[col + 3] && response.game[col + 3][row + 3] && response.game[col + 3][row + 3] !== 0 && response.game[col + 3][row + 3] === response.game[col + 2][row + 2]) {
