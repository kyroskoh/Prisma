...
module.exports = {
    ...
    description: "Puts the PornHub logo in the corner of a user's avatar.",
    usage: "pornhub [url | @user | username | userID]",
    category: "Image",
    hidden: false,
    execute: (bot, r, msg, args) => {
        function next(url) {
            snekfetch.get(url).then((body) => {
                try {
                    gm(body.body).composite("/../data/pornhub.png").geometry("+15+15").toBuffer((error, buffer) => {
